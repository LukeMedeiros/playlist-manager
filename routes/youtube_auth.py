...
# information for this youtube_authlication, including its client_id and client_secret.
...
def authorize():
  ...
  authorization_url, state = flow.authorization_url(
      ...
      # re-prompting the user for permission. Recommended for web server youtube_auths.
      access_type='offline',
...
@youtube_auth.route('/oauth2callback')
def oauth2callback():
